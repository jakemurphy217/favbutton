    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 text-center mb-4">
                ...
                <p>For My Part, I developed the home page and the recipe search. which was a huge learning curve developing with API's in JSON format and using a frameworks such as Axious to call the API and handlebars which is a templating framework that displays the results. Also helped with the Registration.</p>
            </div>
            <div class="col-lg-4 col-sm-6 text-center mb-4">
